...
TEST(execute_next, LH) {
	...
	EXPECT_EQ(hart.get_register(Rv32_register_id::x2), 0x3020);
}
...
TEST(execute_next, LW) {
	...
	auto instruction = Rv32_encoder::encode_lw(Rv32_register_id::x2, Rv32_register_id::x3, 0);
	memory.write_32(0x500, instruction);
...
TEST(execute_next, SB) {
	...
	auto instruction = Rv32_encoder::encode_sb(Rv32_register_id::x2, Rv32_register_id::x3, 0x10);
	memory.write_32(0x500, instruction);

	hart.set_register(Rv32_register_id::pc, 0x500);
	hart.set_register(Rv32_register_id::x2, 0x600);
	hart.set_register(Rv32_register_id::x3, 0x30);
	hart.execute_next();
...
TEST(execute_next, SH) {
	...
	auto instruction = Rv32_encoder::encode_sh(Rv32_register_id::x2, Rv32_register_id::x3, 0x10);
	memory.write_32(0x500, instruction);

	hart.set_register(Rv32_register_id::pc, 0x500);
	hart.set_register(Rv32_register_id::x2, 0x600);
	hart.set_register(Rv32_register_id::x3, 0x2030);
	hart.execute_next();

	EXPECT_EQ(hart.get_register(Rv32_register_id::x2), 0x600);
	EXPECT_EQ(hart.get_register(Rv32_register_id::x3), 0x2030);
	EXPECT_EQ(hart.get_register(Rv32_register_id::pc), 0x504);
...
TEST(execute_lh, PositiveOffset) {
	...
	auto hart = Rv32_hart(memory);
	hart.set_register(Rv32_register_id::x3, 64);
	hart.execute_lh(Rv32_register_id::x2, Rv32_register_id::x3, Rv_itype_imm::from_signed(32));
	EXPECT_EQ(hart.get_register(Rv32_register_id::x2), 0x2010);
	EXPECT_EQ(hart.get_register(Rv32_register_id::x3), 64);
}
...
TEST(execute_lh, PositiveOffsetWrapAround) {
	...
	auto hart = Rv32_hart(memory);
	hart.set_register(Rv32_register_id::x3, 0xFFFFFFFC);
	hart.execute_lh(Rv32_register_id::x2, Rv32_register_id::x3, Rv_itype_imm::from_signed(8));
	EXPECT_EQ(hart.get_register(Rv32_register_id::x2), 0x2010);
	EXPECT_EQ(hart.get_register(Rv32_register_id::x3), 0xFFFFFFFC);
}
...
TEST(execute_lh, ZeroOffset) {
	...
	auto hart = Rv32_hart(memory);
	hart.set_register(Rv32_register_id::x3, 6);
	hart.execute_lh(Rv32_register_id::x2, Rv32_register_id::x3, Rv_itype_imm::from_signed(0));
	EXPECT_EQ(hart.get_register(Rv32_register_id::x2), 0x4030);
	EXPECT_EQ(hart.get_register(Rv32_register_id::x3), 6);
}
...
TEST(execute_lh, MisalignedAccess) {
	...
	auto hart = Rv32_hart(memory);
	hart.set_register(Rv32_register_id::x3, 4);
	hart.execute_lh(Rv32_register_id::x2, Rv32_register_id::x3, Rv_itype_imm::from_signed(1));
	EXPECT_EQ(hart.get_register(Rv32_register_id::x2), 0x3020);
	EXPECT_EQ(hart.get_register(Rv32_register_id::x3), 4);
}
...
TEST(execute_lh, SignExtended) {
	...
	hart.set_register(Rv32_register_id::x3, 4);
	hart.execute_lh(Rv32_register_id::x2, Rv32_register_id::x3, Rv_itype_imm::from_signed(0));
	EXPECT_EQ(hart.get_register(Rv32_register_id::x2), -1 << 15);
}
...
TEST(execute_lhu, PositiveOffset) {
	...
	auto hart = Rv32_hart(memory);
	hart.set_register(Rv32_register_id::x3, 64);
	hart.execute_lhu(Rv32_register_id::x2, Rv32_register_id::x3, Rv_itype_imm::from_signed(32));
	EXPECT_EQ(hart.get_register(Rv32_register_id::x2), 0x2010);
	EXPECT_EQ(hart.get_register(Rv32_register_id::x3), 64);
}
...
TEST(execute_lhu, PositiveOffsetWrapAround) {
	...
	auto hart = Rv32_hart(memory);
	hart.set_register(Rv32_register_id::x3, 0xFFFFFFFC);
	hart.execute_lhu(Rv32_register_id::x2, Rv32_register_id::x3, Rv_itype_imm::from_signed(8));
	EXPECT_EQ(hart.get_register(Rv32_register_id::x2), 0x2010);
	EXPECT_EQ(hart.get_register(Rv32_register_id::x3), 0xFFFFFFFC);
}
...
TEST(execute_lhu, ZeroOffset) {
	...
	auto hart = Rv32_hart(memory);
	hart.set_register(Rv32_register_id::x3, 6);
	hart.execute_lhu(Rv32_register_id::x2, Rv32_register_id::x3, Rv_itype_imm::from_signed(0));
	EXPECT_EQ(hart.get_register(Rv32_register_id::x2), 0x4030);
	EXPECT_EQ(hart.get_register(Rv32_register_id::x3), 6);
}
...
TEST(execute_lhu, MisalignedAccess) {
	...
	auto hart = Rv32_hart(memory);
	hart.set_register(Rv32_register_id::x3, 4);
	hart.execute_lhu(Rv32_register_id::x2, Rv32_register_id::x3, Rv_itype_imm::from_signed(1));
	EXPECT_EQ(hart.get_register(Rv32_register_id::x2), 0x3020);
	EXPECT_EQ(hart.get_register(Rv32_register_id::x3), 4);
}
...
TEST(execute_lw, PositiveOffset) {
	...
	auto hart = Rv32_hart(memory);
	hart.set_register(Rv32_register_id::x3, 64);
	hart.execute_lw(Rv32_register_id::x2, Rv32_register_id::x3, Rv_itype_imm::from_signed(32));
	EXPECT_EQ(hart.get_register(Rv32_register_id::x2), 0x40302010);
	EXPECT_EQ(hart.get_register(Rv32_register_id::x3), 64);
}
...
TEST(execute_lw, PositiveOffsetWrapAround) {
	...
	auto hart = Rv32_hart(memory);
	hart.set_register(Rv32_register_id::x3, 0xFFFFFFFC);
	hart.execute_lw(Rv32_register_id::x2, Rv32_register_id::x3, Rv_itype_imm::from_signed(8));
	EXPECT_EQ(hart.get_register(Rv32_register_id::x2), 0x40302010);
	EXPECT_EQ(hart.get_register(Rv32_register_id::x3), 0xFFFFFFFC);
}
...
TEST(execute_lw, ZeroOffset) {
	...
	auto hart = Rv32_hart(memory);
	hart.set_register(Rv32_register_id::x3, 4);
	hart.execute_lw(Rv32_register_id::x2, Rv32_register_id::x3, Rv_itype_imm::from_signed(0));
	EXPECT_EQ(hart.get_register(Rv32_register_id::x2), 0x40302010);
	EXPECT_EQ(hart.get_register(Rv32_register_id::x3), 4);
}
...
TEST(execute_lw, MisalignedAccess) {
	...
	auto hart = Rv32_hart(memory);
	hart.set_register(Rv32_register_id::x3, 4);
	hart.execute_lw(Rv32_register_id::x2, Rv32_register_id::x3, Rv_itype_imm::from_signed(1));
	EXPECT_EQ(hart.get_register(Rv32_register_id::x2), 0x40302010);
	EXPECT_EQ(hart.get_register(Rv32_register_id::x3), 4);
}
...
TEST(execute_sb, PositiveOffset) {
	...
	hart.set_register(Rv32_register_id::x2, 0x50);
...
TEST(execute_sb, HighBitsOfRegisterIgnored) {
	...
	auto hart = Rv32_hart(memory);
	hart.set_register(Rv32_register_id::x1, 4);
	hart.set_register(Rv32_register_id::x2, -1 << 7);
	hart.execute_sb(Rv32_register_id::x1, Rv32_register_id::x2, Rv_stype_imm::from_offset(0));
	EXPECT_EQ(hart.get_register(Rv32_register_id::x1), 4);
	EXPECT_EQ(hart.get_register(Rv32_register_id::x2), -1 << 7);
...
TEST(execute_sh, PositiveOffset) {
	...
	auto hart = Rv32_hart(memory);
	hart.set_register(Rv32_register_id::x1, 0x100);
	hart.set_register(Rv32_register_id::x2, 0x4050);
	hart.execute_sh(Rv32_register_id::x1, Rv32_register_id::x2, Rv_stype_imm::from_offset(0x10));
	EXPECT_EQ(hart.get_register(Rv32_register_id::x1), 0x100);
	EXPECT_EQ(hart.get_register(Rv32_register_id::x2), 0x4050);
...
TEST(execute_sh, PositiveOffsetWrapAround) {
	...
	hart.set_register(Rv32_register_id::x1, 0xFFFFFFFC);
	hart.set_register(Rv32_register_id::x2, 0x4050);
	hart.execute_sh(Rv32_register_id::x1, Rv32_register_id::x2, Rv_stype_imm::from_offset(8));
	EXPECT_EQ(hart.get_register(Rv32_register_id::x1), 0xFFFFFFFC);
	EXPECT_EQ(hart.get_register(Rv32_register_id::x2), 0x4050);
...
TEST(execute_sh, NegativeOffset) {
	...
	hart.set_register(Rv32_register_id::x1, 64);
	hart.set_register(Rv32_register_id::x2, 0x4050);
	hart.execute_sh(Rv32_register_id::x1, Rv32_register_id::x2, Rv_stype_imm::from_offset(-32));
	EXPECT_EQ(hart.get_register(Rv32_register_id::x1), 64);
	EXPECT_EQ(hart.get_register(Rv32_register_id::x2), 0x4050);
...
TEST(execute_sh, ZeroOffset) {
	...
	hart.set_register(Rv32_register_id::x1, 6);
	hart.set_register(Rv32_register_id::x2, 0x4050);
	hart.execute_sh(Rv32_register_id::x1, Rv32_register_id::x2, Rv_stype_imm::from_offset(0));
	EXPECT_EQ(hart.get_register(Rv32_register_id::x1), 6);
	EXPECT_EQ(hart.get_register(Rv32_register_id::x2), 0x4050);
...
TEST(execute_sh, MisalignedAccess) {
	...
	hart.set_register(Rv32_register_id::x1, 4);
	hart.set_register(Rv32_register_id::x2, 0x4050);
	hart.execute_sh(Rv32_register_id::x1, Rv32_register_id::x2, Rv_stype_imm::from_offset(1));
	EXPECT_EQ(hart.get_register(Rv32_register_id::x1), 4);
	EXPECT_EQ(hart.get_register(Rv32_register_id::x2), 0x4050);
...
TEST(execute_sh, HighBitsOfRegisterIgnored) {
	...
	auto hart = Rv32_hart(memory);
	hart.set_register(Rv32_register_id::x1, 4);
	hart.set_register(Rv32_register_id::x2, -1 << 15);
	hart.execute_sh(Rv32_register_id::x1, Rv32_register_id::x2, Rv_stype_imm::from_offset(0));
	EXPECT_EQ(hart.get_register(Rv32_register_id::x1), 4);
	EXPECT_EQ(hart.get_register(Rv32_register_id::x2), -1 << 15);
