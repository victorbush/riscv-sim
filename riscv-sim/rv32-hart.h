...
public:
	...
	void execute_ebreak(Rv32_register_id rd, Rv32_register_id rs1, Rv_itype_imm imm);
	void execute_ecall(Rv32_register_id rd, Rv32_register_id rs1, Rv_itype_imm imm);
	void execute_fence(Rv32_register_id rd, Rv32_register_id rs1, Rv_itype_imm imm);
	void execute_jal(Rv32_register_id rd, Rv_jtype_imm imm);
	void execute_jalr(Rv32_register_id rd, Rv32_register_id rs1, Rv_itype_imm imm);
